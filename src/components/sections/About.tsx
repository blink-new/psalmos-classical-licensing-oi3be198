            ...
            <div>
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <p className="text-muted-foreground">
                    <span className="font-medium text-primary">Automated Licensing:</span> Instant micro-licenses with transparent revenue distribution to all rights holders.
                  </p>
                </div>
                <div className="flex items-start space-x-3">
                  <CheckCircle className="h-5 w-5 text-accent mt-1 flex-shrink-0" />
                  <p className="text-muted-foreground">
                    <span className="font-medium text-primary">Global Platform:</span> Unified access to recordings from 50+ prestigious classical labels worldwide.
                  </p>
                </div>
                <div className="flex items-start space-x-3">
                  <CheckCircle className="h-5 w-5 text-accent mt-1 flex-shrink-0" />
                  <p className="text-muted-foreground">
                    <span className="font-medium text-primary">Creator-Friendly:</span> Simple subscription model with unlimited downloads and clear usage rights.
                  </p>
                </div>
              </div>
            </div>
